...
# my_string prints out "pumpkins" since the oringal my_string variable was never changed.
# my_array prints out ["pumpkins", "rutabaga"] because the "<<" operator is destructive and works on the original object.
...
# my_string prints out "rutabaga" because the gsub! method is destructive and works on the original object.
# my_array prints out ["pumpkins"] because the original object is never altered. 
...
# Therefore the following will return the same as above.
